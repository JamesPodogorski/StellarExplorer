...
public class UnitTestBoundary
{
    [Fact]
    public async void TestGetAllBoundaries()
    {
        //* Config Options
        ...
        //* Services
        serviceCollection.AddTransient<IBoundaryRepository, BoundaryRepository>();
        ...
        var boundaryRepository = provider.GetService<IBoundaryRepository>();
        var resp = await boundaryRepository.GetAll();
