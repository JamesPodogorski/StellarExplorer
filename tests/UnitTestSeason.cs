...
public class UnitTestSeason
{
    [Fact]
    public async void TestGetAllSeasons()
    {
        //* Config Options
        ...
        //* Services
        serviceCollection.AddTransient<ISeasonRepository, SeasonRepository>();
        ...
        var seasonRepository = provider.GetService<ISeasonRepository>();
        var resp = await seasonRepository.GetAll();
